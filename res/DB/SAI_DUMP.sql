...
-- 테이블 데이터 sai.album_media:~8 rows (대략적) 내보내기
...
-- 테이블 데이터 sai.board:~21 rows (대략적) 내보내기
...
INSERT INTO `board` (`board_id`, `family_id`, `user_id`, `board_reg_datetime`, `board_content`, `board_like_cnt`, `board_reply_cnt`, `board_date`, `board_location`, `board_tagged_yn`, `board_media_yn`, `poll_yn`) VALUES
	...
	(14, '305305', 'boyy', '2022-08-18 07:04:54', '부산에서 탄 바다 열차', 0, 0, NULL, '부산 해운대구 청사포로 116 (중동)', 0, 1, 0);
/*!40000 ALTER TABLE `board` ENABLE KEYS */;

-- 테이블 데이터 sai.board_like:~26 rows (대략적) 내보내기
...
INSERT INTO `board_media` (`board_media_id`, `board_id`, `board_media_thumbnail`, `board_media_thumb_server`, `board_media_path`, `board_media_path_server`, `board_media_original_name`, `board_media_type`) VALUES
	...
	(10, 14, '/saimedia/Feed/305305/th_90f71ac8-7dbc-4dc7-91f0-464febee20df_KakaoTalk_20220818_155233498 (video-converter.com).mp4', '/app/Feed/305305/th_90f71ac8-7dbc-4dc7-91f0-464febee20df_KakaoTalk_20220818_155233498 (video-converter.com).mp4', '/saimedia/Feed/305305/90f71ac8-7dbc-4dc7-91f0-464febee20df_KakaoTalk_20220818_155233498 (video-converter.com).mp4', '/app/Feed/305305/90f71ac8-7dbc-4dc7-91f0-464febee20df_KakaoTalk_20220818_155233498 (video-converter.com).mp4', 'KakaoTalk_20220818_155233498 (video-converter.com).mp4', 'video/mp4');
/*!40000 ALTER TABLE `board_media` ENABLE KEYS */;

-- 테이블 데이터 sai.board_tagged:~4 rows (대략적) 내보내기
...
-- 테이블 데이터 sai.choice:~6 rows (대략적) 내보내기
...
-- 테이블 데이터 sai.family:~2 rows (대략적) 내보내기
...
-- 테이블 데이터 sai.family_callsign:~37 rows (대략적) 내보내기
...
-- 테이블 데이터 sai.main_plan:~5 rows (대략적) 내보내기
...
-- 테이블 데이터 sai.memo:~8 rows (대략적) 내보내기
...
-- 테이블 데이터 sai.notification:~30 rows (대략적) 내보내기
...
-- 테이블 데이터 sai.poll:~2 rows (대략적) 내보내기
...
-- 테이블 데이터 sai.reply:~16 rows (대략적) 내보내기
...
-- 테이블 데이터 sai.user:~8 rows (대략적) 내보내기
