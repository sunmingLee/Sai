...
CREATE TABLE IF NOT EXISTS `sai`.`board` (
  ...
  `board_reply_cnt` INT NULL DEFAULT 0,
  `board_date` DATE NULL,
  `board_location` VARCHAR(40) NULL,
  `board_tagged_yn` TINYINT(1) NULL,
...
CREATE TABLE IF NOT EXISTS `sai`.`board_media` (
  `board_media_id` BIGINT NOT NULL AUTO_INCREMENT,
  `board_id` BIGINT NOT NULL,
  `board_media_thumbnail` VARCHAR(255) NULL,
  `board_media_path` VARCHAR(255) NULL,
  `board_media_original_name` VARCHAR(255) NULL,
  `board_media_save_name` VARCHAR(255) NULL,
  `board_media_type` VARCHAR(10) NULL,
...
CREATE TABLE IF NOT EXISTS `sai`.`album_media` (
  ...
  `album_media_thumbnail` VARCHAR(255) NULL,
  `album_media_path` VARCHAR(255) NULL,
  `album_media_original_name` VARCHAR(255) NULL,
  `album_media_save_name` VARCHAR(255) NULL,
